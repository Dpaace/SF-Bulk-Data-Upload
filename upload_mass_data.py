...
#         result = response.json()
#         if result.get("hasErrors"):
#             print(f"Batch {batch_num}: Partially failed")
#         else:
#             print(f"Batch {batch_num}: All records uploaded successfully")
...
#         all_records = read_csv_records(CSV_FILE_PATH)
#         batches = batch_records(all_records)
#         print(f"Total records: {len(all_records)} split into {len(batches)} batches")
